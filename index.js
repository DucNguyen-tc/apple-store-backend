...
const productPromotionRoutes = require("./routes/productPromotion.route"); // Import product promotion routes
...
app.use("/api/product-promotions", productPromotionRoutes); // Product promotion routes
